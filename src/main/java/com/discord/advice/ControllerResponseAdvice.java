package com.discord.advice;

import com.discord.common.R;
import com.discord.exception.APIException;
import com.discord.utils.NotControllerResponseAdvice;
...
@RestControllerAdvice(basePackages = {"com.discord"})
